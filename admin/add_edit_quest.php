                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <div class="form-group"><label for="company" class="form-control-label">
                                                Câu hỏi
                                            </label><input type="text" name="question" placeholder="Thêm câu hỏi" class="form-control"></div>

                                        <!-- op1 -->
                                        <div class="form-group"><label for="company" class="form-control-label">Lựa
                                                chọn 1
                                            </label><input type="text" name="opt1" placeholder="Thêm lựa chọn" class="form-control"></div>

                                        <!-- op2 -->
                                        <div class="form-group"><label for="company" class="form-control-label">Lựa
                                                chọn 2
                                            </label><input type="text" name="opt2" placeholder="Thêm lựa chọn" class="form-control"></div>

                                        <!-- op3 -->
                                        <div class="form-group"><label for="company" class="form-control-label">Lựa
                                                chọn 3
                                            </label><input type="text" name="opt3" placeholder="Thêm lựa chọn" class="form-control"></div>

                                        <!-- op4 -->
                                        <div class="form-group"><label for="company" class="form-control-label">Lựa
                                                chọn 4
                                            </label><input type="text" name="opt4" placeholder="Thêm lựa chọn" class="form-control"></div>

                                        <!-- Answer -->
                                        <div class="form-group"><label for="company" class="form-control-label">Câu đáp
                                                án
                                            </label><input type="text" name="answer" placeholder="Thêm đáp án" class="form-control"></div>
                                        ...
                                        <div class="form-group">
                                            <input type="submit" name="submitl" value="Thêm câu hỏi" class="btn btn-success">
                                        </div>
                                    </div>
                                </div>
                                <!-- </form> -->
                                ...
                                <div class="card">
                                    ...
                                    <div class="card-body card-block">
                                        <div class="form-group"><label for="company" class="form-control-label"> Câu
                                                hỏi
                                            </label><input type="text" name="fquestion" placeholder="Thêm câu hỏi" class="form-control"></div>

                                        <!-- op1 -->
                                        <div class="form-group"><label for="company" class="form-control-label">Lựa
                                                chọn 1
                                            </label><input type="file" name="fopt1" class="form-control" style="padding-bottom: 35px;"></div>

                                        <!-- op2 -->
                                        <div class="form-group"><label for="company" class="form-control-label">Lựa
                                                chọn 2
                                            </label><input type="file" name="fopt2" class="form-control" style="padding-bottom: 35px;"></div>

                                        <!-- op3 -->
                                        <div class="form-group"><label for="company" class="form-control-label">Lựa
                                                chọn 3
                                            </label><input type="file" name="fopt3" class="form-control" style="padding-bottom: 35px;"></div>

                                        <!-- op4 -->
                                        <div class="form-group"><label for="company" class="form-control-label">Lựa
                                                chọn 4
                                            </label><input type="file" name="fopt4" class="form-control" style="padding-bottom: 35px;"></div>


                                        <!-- Answer -->
                                        <div class="form-group"><label for="company" class="form-control-label">Câu đáp
                                                án
                                            </label><input type="file" name="fAnswer" class="form-control" style="padding-bottom: 35px;"></div>
                                        ...
                                        <!-- Add Quest -->
                                        <div class="form-group">
                                            <input type="submit" name="submit2" value="Thêm câu hỏi" class="btn btn-success">
                                        </div>
                                    </div>
                                </div>
                            </div>
